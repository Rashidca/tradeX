...
from bearbullui import display_researcher_rounds_withexpander
...
from riskui import display_risk_analysis_rounds_withexpander
...
if st.button("🚀 Proceed"):
    ...
    if ticker.strip() == "":
        ...
        if df is None or df.empty:
            ...
            riskanalysis_container=st.container()
            ...
            with researcher_container:
                ...
                with st.spinner("Running Researcher Debate..."):
                    ...
                    content_dict=display_researcher_rounds_withexpander(content_dict)
            with riskanalysis_container:
                ...
                with st.spinner("Running Risk Analysis Debate..."):
                    ...
                    content_dict=display_risk_analysis_rounds_withexpander(content_dict)
